...
import { StyledForm, FieldWrapper } from '../../../../../src/components/Form/JSONSchemaForm/styledComponents';
...
describe('<JSONSchemaForm />', () => {
	...
	it('should render a <FieldWrapper /> with .button-container class', () => {
		wrapper = shallow(<JSONSchemaForm {... props} />);
		expect(wrapper.find(StyledForm).find(FieldWrapper).hasClass('button-container')).toEqual(true);
	});
