...
import { setAllTokensTradingPermission, toggleTokenTradingPermission } from '../../../../src/components/TradingPermissions/actions';
...
describe('<TradingPermissionsContainer />', () => {
	...
	beforeEach(() => {
		...
		wrapper = shallow(<Provider store={store}><TradingPermissionsContainer /></Provider>);
	});
