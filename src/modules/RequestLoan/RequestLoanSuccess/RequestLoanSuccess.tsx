		...
		return (
			<PaperLayout>
				<MainWrapper>
					...
					<ShareRequestURL issuanceHash={this.props.debtOrder.issuanceHash} requestURL={'dharma.io/' + this.props.debtOrder.debtorSignature} onShareSocial={this.handleShareSocial} />
